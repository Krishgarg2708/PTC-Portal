...
export const translations: Record<Language, Translation> = {
  en: {
    ...
    downloadHint: 'Saves directly as .xlsx to your Downloads folder',
  ...
  hi: {
    ...
    downloadCta: 'स्प्रेडशीट डाउनलोड करें',
    downloadHint: 'फ़ाइल सीधे .xlsx के रूप में आपके डाउनलोड्स फ़ोल्डर में सेव होगी',
